...
<!-- COPIED by bin/sync-skills from wind/skills/wind-ui/SKILL.md. Do not edit here: edit it in that repository,
     then re-run the script. Source version 2.11.0, sha256 a61ebac733d5a528e5c66302ad3cce652ecc12a4dc54dcdc76adfc2b3e96895f.
...
| `WCheckbox` | Form (raw) | none | Boolean checkbox; auto-injects `checked:` state when `value: true`. Default className includes `checked:bg-primary` (`primary` is a seeded default token aliased to blue; override it in `WindThemeData.colors` to rebrand). |
