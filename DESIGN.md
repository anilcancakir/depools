...
- Reflow vertically at narrow widths. Never truncate to fit, and never branch the widget tree per platform when a breakpoint prefix expresses the same thing.
