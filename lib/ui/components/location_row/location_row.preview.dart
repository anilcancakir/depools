      ...
      children: [
        ...
        WDiv(
          ...
          children: [
            ...
            LocationRow(name: 'Mavi', depth: 0, productCount: 1, icon: 'kitchen', colour: 'blue', onTap: _noop),
            LocationRow(name: 'Turkuaz', depth: 0, productCount: 1, icon: 'ac_unit', colour: 'teal', onTap: _noop),
            LocationRow(name: 'Yeşil', depth: 0, productCount: 1, icon: 'shelves', colour: 'green', onTap: _noop),
            LocationRow(name: 'Sarı', depth: 0, productCount: 1, icon: 'dining', colour: 'amber', onTap: _noop),
            LocationRow(name: 'Kırmızı', depth: 0, productCount: 1, icon: 'shopping_basket', colour: 'red', onTap: _noop),
