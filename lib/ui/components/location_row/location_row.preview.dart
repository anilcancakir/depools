      ...
      children: [
        WDiv(
          ...
          children: [
            ...
            LocationRow(name: 'Derin dondurucu', depth: 1, productCount: 1, itemSummary: '1 ürün'),
            LocationRow(
              name: 'Kiler',
              depth: 0,
              productCount: 4,
            ...
            LocationRow(name: 'Raf 1', depth: 1, productCount: 1, itemSummary: '1 ürün'),
            LocationRow(name: 'Raf 2', depth: 1, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Çekmece 2', depth: 1, productCount: 1, itemSummary: '1 ürün'),
          ],
        ),
        WDiv(
          className: 'flex flex-col gap-1 p-4 rounded-lg bg-surface-container',
          children: [
            ...
            LocationRow(name: 'Koridor B', depth: 1, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Raf A', depth: 2, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Kutu 3', depth: 3, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Bölme 1', depth: 4, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Göz 2', depth: 5, productCount: 2, itemSummary: '2 ürün'),
            LocationRow(name: 'Raf B', depth: 1, productCount: 0, itemSummary: 'Boş'),
          ],
        ),
      ],
    );
