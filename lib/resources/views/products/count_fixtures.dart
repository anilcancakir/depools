...
class CountLine {
  ...
  ///
  /// It also used to be hardcoded Turkish, which no gate could see: `no_hardcoded_copy_test` skips
  /// `*_fixtures.dart`, so an English interface rendered `Sayılmadı` for as long as the screen only
  /// ever drew fixtures.
  String get verdict {
