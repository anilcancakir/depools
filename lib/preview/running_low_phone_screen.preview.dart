...
/// Feature-screen preview: running low in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that three certainty tiers, each with a note line above rows carrying two figures.
///
...
class RunningLowPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame running low preview.
  const RunningLowPhoneScreenPreview({super.key});
