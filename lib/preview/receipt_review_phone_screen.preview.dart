...
/// Feature-screen preview: receipt review in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that two-column line rows with a quantity and a verdict on the right.
///
...
class ReceiptReviewPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame receipt review preview.
  const ReceiptReviewPhoneScreenPreview({super.key});
