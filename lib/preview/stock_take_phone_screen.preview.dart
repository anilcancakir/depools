...
/// Feature-screen preview: stock take in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that count rows with fixed-width columns that were tuned at desktop width.
///
...
class StockTakePhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame stock take preview.
  const StockTakePhoneScreenPreview({super.key});
