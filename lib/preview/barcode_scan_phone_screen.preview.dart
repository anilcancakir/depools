...
/// Feature-screen preview: barcode scan in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that the viewfinder, the barcode field and the scanned list stack into one column.
///
...
class BarcodeScanPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame barcode scan preview.
  const BarcodeScanPhoneScreenPreview({super.key});
