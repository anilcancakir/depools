...
/// Feature-screen preview: shelf photo in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that a photograph with absolutely-positioned boxes over it.
///
...
class ShelfPhotoPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame shelf photo preview.
  const ShelfPhotoPhoneScreenPreview({super.key});
