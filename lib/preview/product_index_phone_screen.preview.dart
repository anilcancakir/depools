...
/// Feature-screen preview: product index in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that the densest repeating row in the app, plus a filter bar that wraps.
///
...
class ProductIndexPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame product index preview.
  const ProductIndexPhoneScreenPreview({super.key});
