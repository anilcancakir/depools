...
/// Feature-screen preview: product draft in a phone frame, inside the real app shell.
///
...
///
/// Here the specific risk is that nine inferred fields, each a row of label plus value plus provenance.
///
...
class ProductDraftPhoneScreenPreview extends StatelessWidget {
  /// Creates the phone-frame product draft preview.
  const ProductDraftPhoneScreenPreview({super.key});
